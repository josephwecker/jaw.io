(function() {
  $(window).load(function() {
    ...
    return $(window).scroll(function() {
      ...
      $('article header').css('color', 'rgb(' + Math.floor(Math.max(47.0, 47.0 + ((167.0 - 47.0) * step))) + ',' + Math.floor(Math.max(56.0, 56.0 + ((169.0 - 56.0) * step))) + ',' + Math.floor(Math.max(58.0, 58.0 + ((169.0 - 58.0) * step))) + ')');
